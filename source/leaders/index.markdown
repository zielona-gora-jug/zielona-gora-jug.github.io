...
<div class="leaders">
	...
	<div class="leader">
		...
		<p class="desc">
			Programista, zainteresowany wszystkim tym co związane jest z kodowaniem, nie tylko JVM, zielonogórzanin z wyboru, wierzący w moc pracy zdalnej, czerpiący energię z jazdy na rowerze górskim i zimowych zjazdów na nartach.
		</p>
	</div>
	<div class="clear"></div>
</div>
